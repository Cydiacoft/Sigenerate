...
class MetroLineInfo {
  ...
  static List<MetroLineInfo> getLines(MetroCityStyle style) {
    switch (style) {
      case MetroCityStyle.shanghai: return shanghaiLines;
      case MetroCityStyle.guangzhou: return guangzhouLines;
      case MetroCityStyle.mtr: return mtrLines;
    }
  }
  ...
  static const List<MetroLineInfo> shanghaiLines = [
    ...
    MetroLineInfo(num: 13, name: '13号线', nameEn: 'Line 13', color: Color(0xFF8E3700), city: MetroCity.shanghai),
    MetroLineInfo(num: 14, name: '14号线', nameEn: 'Line 14', color: Color(0xFF4D3700), city: MetroCity.shanghai),
    MetroLineInfo(num: 15, name: '15号线', nameEn: 'Line 15', color: Color(0xFFBF83BC), city: MetroCity.shanghai),
  ...
  static const List<MetroLineInfo> guangzhouLines = [
    ...
    MetroLineInfo(num: 9, name: '9号线', nameEn: 'Line 9', color: Color(0xFF838900), city: MetroCity.guangzhou),
    MetroLineInfo(num: 13, name: '13号线', nameEn: 'Line 13', color: Color(0xFFB75700), city: MetroCity.guangzhou),
    MetroLineInfo(num: 14, name: '14号线', nameEn: 'Line 14', color: Color(0xFFCC6699), city: MetroCity.guangzhou),
    MetroLineInfo(num: 18, name: '18号线', nameEn: 'Line 18', color: Color(0xFFB75700), city: MetroCity.guangzhou),
    MetroLineInfo(num: 21, name: '21号线', nameEn: 'Line 21', color: Color(0xFF4DB749), city: MetroCity.guangzhou),
    MetroLineInfo(num: 22, name: '22号线', nameEn: 'Line 22', color: Color(0xFF7D2E8D), city: MetroCity.guangzhou),
  ];
  ...
  static const List<MetroLineInfo> mtrLines = [
    ...
    MetroLineInfo(num: 8, name: '将军澳线', nameEn: 'Tseung Kwan O Line', color: Color(0xFF7B4998), city: MetroCity.mtr),
    MetroLineInfo(num: 9, name: '机场快线', nameEn: 'Airport Express', color: Color(0xFF0072CE), city: MetroCity.mtr),
...
class MetroTemplate {
  ...
  static List<MetroTemplate> getTemplates(MetroCity city) {
    return _templates.where((t) => t.city == city || t.city == MetroCity.shanghai).toList();
  }
  ...
  static const List<MetroTemplate> _templates = [
    MetroTemplate(
      ...
      defaultBgColor: Color(0xFF383838),
      slots: [
    ...
    MetroTemplate(
      ...
      slots: [
        ...
        MetroSlot(id: 'line_name_cn', type: 'text', x: 85, y: 18, w: 220, h: 26, fontSize: 18),
        MetroSlot(id: 'line_name_en', type: 'text', x: 85, y: 44, w: 220, h: 20, fontSize: 11, color: Color(0xFF999999)),
        MetroSlot(id: 'direction', type: 'text', x: 85, y: 64, w: 220, h: 18, fontSize: 10, color: Color(0xFF777777)),
      ],
    ),
  ];
}
...
class RoadTemplate {
  ...
  static const List<RoadTemplate> templates = [
    RoadTemplate(
      ...
      slots: [
        RoadSlot(id: 'title', type: 'text', x: 10, y: 8, w: 180, h: 22, fontSize: 12, color: Color(0xFFCCEECC)),
        RoadSlot(id: 'north_arrow', type: 'arrow_up', x: 20, y: 45, w: 24, h: 24),
        RoadSlot(id: 'north_road', type: 'text', x: 50, y: 45, w: 180, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'north_dest', type: 'text', x: 50, y: 72, w: 180, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
        RoadSlot(id: 'south_arrow', type: 'arrow_down', x: 20, y: 110, w: 24, h: 24),
        RoadSlot(id: 'south_road', type: 'text', x: 50, y: 110, w: 180, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'south_dest', type: 'text', x: 50, y: 137, w: 180, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
        RoadSlot(id: 'east_arrow', type: 'arrow_right', x: 280, y: 45, w: 24, h: 24),
        RoadSlot(id: 'east_road', type: 'text', x: 310, y: 45, w: 180, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'east_dest', type: 'text', x: 310, y: 72, w: 180, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
        RoadSlot(id: 'west_arrow', type: 'arrow_left', x: 280, y: 110, w: 24, h: 24),
        RoadSlot(id: 'west_road', type: 'text', x: 310, y: 110, w: 180, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'west_dest', type: 'text', x: 310, y: 137, w: 180, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
      ],
    ),
    RoadTemplate(
      id: 'tjunc',
      ...
      defaultBgColor: Color(0xFF059669),
      slots: [
        RoadSlot(id: 'title', type: 'text', x: 10, y: 8, w: 150, h: 22, fontSize: 12, color: Color(0xFFCCEECC)),
        RoadSlot(id: 'north_arrow', type: 'arrow_up', x: 20, y: 50, w: 24, h: 24),
        RoadSlot(id: 'north_road', type: 'text', x: 50, y: 50, w: 160, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'north_dest', type: 'text', x: 50, y: 77, w: 160, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
        RoadSlot(id: 'east_arrow', type: 'arrow_right', x: 250, y: 50, w: 24, h: 24),
        RoadSlot(id: 'east_road', type: 'text', x: 280, y: 50, w: 150, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'east_dest', type: 'text', x: 280, y: 77, w: 150, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
        RoadSlot(id: 'west_arrow', type: 'arrow_left', x: 250, y: 100, w: 24, h: 24),
        RoadSlot(id: 'west_road', type: 'text', x: 280, y: 100, w: 150, h: 26, fontSize: 18, fontWeight: FontWeight.bold),
        RoadSlot(id: 'west_dest', type: 'text', x: 280, y: 127, w: 150, h: 20, fontSize: 12, color: Color(0xFFBBDDBB)),
      ],
    ),
    RoadTemplate(
      id: 'direct',
      ...
      slots: [
        RoadSlot(id: 'main_road', type: 'text', x: 10, y: 10, w: 180, h: 40, fontSize: 20, fontWeight: FontWeight.bold),
        RoadSlot(id: 'arrow', type: 'arrow_up', x: 85, y: 70, w: 30, h: 40),
        RoadSlot(id: 'dest1', type: 'text', x: 10, y: 130, w: 180, h: 30, fontSize: 18, fontWeight: FontWeight.w600),
        RoadSlot(id: 'dist1', type: 'text', x: 10, y: 160, w: 180, h: 20, fontSize: 12, color: Color(0xFFAADDFF)),
        RoadSlot(id: 'dest2', type: 'text', x: 10, y: 200, w: 180, h: 30, fontSize: 18, fontWeight: FontWeight.w600),
        RoadSlot(id: 'dist2', type: 'text', x: 10, y: 230, w: 180, h: 20, fontSize: 12, color: Color(0xFFAADDFF)),
        RoadSlot(id: 'dest3', type: 'text', x: 10, y: 270, w: 180, h: 30, fontSize: 18, fontWeight: FontWeight.w600),
        RoadSlot(id: 'dist3', type: 'text', x: 10, y: 300, w: 180, h: 20, fontSize: 12, color: Color(0xFFAADDFF)),
      ],
    ),
    RoadTemplate(
      id: 'entrance',
      ...
      defaultBgColor: Color(0xFF059669),
      slots: [
        RoadSlot(id: 'entrance_type', type: 'text', x: 10, y: 10, w: 100, h: 22, fontSize: 12, color: Color(0xFFCCEECC)),
        RoadSlot(id: 'highway_name', type: 'text', x: 10, y: 45, w: 480, h: 55, fontSize: 32, fontWeight: FontWeight.bold),
        RoadSlot(id: 'exits', type: 'text', x: 10, y: 115, w: 480, h: 30, fontSize: 16),
        RoadSlot(id: 'dists', type: 'text', x: 10, y: 150, w: 480, h: 25, fontSize: 14, color: Color(0xFFBBDDBB)),
      ],
    ),
    RoadTemplate(
      id: 'exit_sign',
      ...
      slots: [
        RoadSlot(id: 'exit_num', type: 'text', x: 15, y: 15, w: 80, h: 35, fontSize: 28, fontWeight: FontWeight.bold),
        RoadSlot(id: 'exit_label', type: 'text', x: 100, y: 22, w: 60, h: 22, fontSize: 14, color: Color(0xFFFFCCCC)),
        RoadSlot(id: 'dest1', type: 'text', x: 15, y: 60, w: 370, h: 30, fontSize: 20, fontWeight: FontWeight.w600),
        RoadSlot(id: 'dest2', type: 'text', x: 15, y: 95, w: 370, h: 30, fontSize: 18),
        RoadSlot(id: 'dist', type: 'text', x: 15, y: 125, w: 370, h: 20, fontSize: 12, color: Color(0xFFFFCCCC)),
      ],
    ),
    RoadTemplate(
      id: 'speed_limit',
      ...
      defaultBgColor: Color(0xFFE60000),
      slots: [
        RoadSlot(id: 'speed', type: 'text', x: 10, y: 20, w: 80, h: 60, fontSize: 36, fontWeight: FontWeight.bold),
      ],
    ),
  ];
}
  ...
  static List<MetroTemplate> getByCity(MetroCityStyle style) {
    switch (style) {
      case MetroCityStyle.shanghai:
        return MetroTemplate._templates.where((t) => t.city == MetroCity.shanghai).toList();
      case MetroCityStyle.guangzhou:
        return MetroTemplate._templates.where((t) => t.city == MetroCity.guangzhou || t.city == MetroCity.shanghai).toList();
      case MetroCityStyle.mtr:
        return MetroTemplate._templates.where((t) => t.city == MetroCity.mtr || t.city == MetroCity.shanghai).toList();
    }
  }
}
